...
namespace BasicArrFunc
{
    public class clsBasicArrFunc
    {
        ...
        public static int[] InitIntArray(int len, int minA = Int32.MinValue, int maxA = Int32.MaxValue)
        {
            int size = len;
            if (size == 0)
            {
        ...
        public static int[] ReadIntArray(int num, string message1 = "", string message2 = "")
        {
            int[] ar = new int[num];
            if (num > 0)
            {
